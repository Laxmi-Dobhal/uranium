...
const createBook= async function (req, res) {
  ...
  //  solution 3 (c)
  if (!publisherId) {   return res.send("publisher id must be present in the request body  this detail is required");
     }
                      
 //  solution 3 (d)
 let publisher = await publisherModel.findById(publisherId);
if (!publisher) {  return res.send("no publisher present with the given id this detail is required");
   }
